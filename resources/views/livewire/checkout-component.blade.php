                        ...
                        <div class="wrap-address-billing">
                            ...
                            <div class="billing-address">
                                ...
                                <p class="row-in-form">
                                    ...
                                    <input type="number" name="phone" value="" placeholder="070 123 4567"wire:model="mobile">
                                    @error('mobile') <span class="text-danger">{{ $message }}</span> @enderror
                                </p>
                                <p class="row-in-form">
                                    <label for="add">line1:</label>
                                    <input  type="text" name="add" value="" placeholder="Box/Apt Number"wire:model="line1">
                                    @error('line1') <span class="text-danger">{{ $message }}</span> @enderror
                                </p>
                                <p class="row-in-form">
                                    <label for="add">line2:</label>
                                    <input  type="text" name="add" value="" placeholder="Street at address"wire:model="line2">
                                </p>
                                <p class="row-in-form">
                                    <label for="country">Country<span>*</span></label>
                                    <input  type="text" name="country" value="" placeholder="Sri Lanka"wire:model="country">
                        ...
                        <div class="col-md-12">
                            <div class="wrap-address-billing">
                                ...
                                <div class="billing-address">
                                    ...
                                    <p class="row-in-form">
                                        <label for="phone">Phone number<span>*</span></label>
                                        <input type="number" name="phone" value="" placeholder="070 123 4567" wire:model="s_mobile">
                                        @error('s_mobile') <span class="text-danger">{{ $message }}</span> @enderror
                                    </p>
                                    <p class="row-in-form">
                                        <label for="add">line1:</label>
                                        <input  type="text" name="add" value="" placeholder="Box/Apt Number" wire:model="s_line1">
                                        @error('s_line1') <span class="text-danger">{{ $message }}</span> @enderror
                                    </p>
                                    <p class="row-in-form">
                                        <label for="add">line2:</label>
                                        <input  type="text" name="add" value="" placeholder="Street Adresss" wire:model="s_line2">
                                    </p>
                                    <p class="row-in-form">
                                        <label for="country">Country<span>*</span></label>
                                        <input  type="text" name="country" value="" placeholder="Sri Lanka" wire:model="s_country">
				...
				<div class="summary summary-checkout">
					<div class="summary-item payment-method">
                        ...
                        @if(Session::has('coupon'))
                             <p class="summary-info grand-total"><span>Grand Total</span> <span class="grand-total-price">&#8358;{{ Session::get('checkout')['total'] }}</span>
                            </p>
                         @else
                            <p class="summary-info grand-total"><span>Grand Total</span> <span class="grand-total-price">LKR:
                                {{ Session::get('checkout', Cart::instance('cart')->subtotal()) }}</span>
                            </p>
                        @endif
