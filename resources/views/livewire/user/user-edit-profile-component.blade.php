                ...
                <div class="panel-body">
                    ...
                    <form wire:submit.prevent="updateProfile">
                        <div class="col-md-4">
                            ...
                            @else
                                <img src="{{asset('assets/images/profile/download.jfif')}}" width="100%" />
                        ...
                        <div class="col-md-8">
                            ...
                            <p><b>Email: </b><input type="text" class="form-control" wire:model="email" /></p>
                            ...
                            <p><b>Country: </b><input type="text" placeholder="SL"class="form-control" wire:model="country"/></p>
