					...
					<div class="widget mercado-widget filter-widget brand-widget">
						...
						<div class="widget-content">
							<ul class="list-style vertical-list list-limited" data-show="6">
								...
								<li class="list-item"><a  class="btn-control control-show-more" href="#">Show more<i class="fa fa-angle-down" aria-hidden="true"></i></a></li>
							</ul>
						</div>
					</div>
               <!-- brand widget if showmore not work data-label='Show less<i class="fa fa-angle-up" aria-hidden="true"></i>'-->
