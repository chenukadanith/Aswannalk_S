													...
													<div id="comment-20" class="comment_container">
														...
														<div class="comment-text">
															...
															<p class="meta">
																...
																<time class="woocommerce-review__published-date" datetime="2022-02-14 20:00" >{{ Carbon\Carbon::parse($orderItem->review->created_at)->format('d F Y g:i A') }}</time>
															</p>
								...
								<li class="service">
									<a class="link-to-service" href="#">
										...
										<div class="right-content">
											...
											<span class="subtitle">On Oder Over LKR 1000</span>
											<p class="desc">Fast, Simple & Quick Deliver Service</p>
										</div>
									</a>
								</li>
								...
								<li class="service">
									<a class="link-to-service" href="#">
										...
										<div class="right-content">
											...
											<p class="desc">Special Offers For New Products</p>
										</div>
									</a>
								</li>
								...
								<li class="product-item">
									<div class="product product-widget-style">
										...
										<div class="product-info">
											...
											<div class="wrap-price"><span class="product-price">LKR {{$p_product->regular_price}}</span></div>
										</div>
									</div>
								</li>
                                @endforeach
							...
							<div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
								...
								<div class="product product-style-2 equal-elem ">
									...
									<div class="product-info">
										...
										<div class="wrap-price"><span class="product-price">LKR {{$r_products->regular_price}}</span></div>
									</div>
								</div>
                                @endforeach
