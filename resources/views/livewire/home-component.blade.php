<main id="main">
		<div class="container">
			...
			<div class="wrap-show-advance-info-box style-1 has-countdown">
				<h3 class="title-box">FLASH DEALZ</h3>
				...
				<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container " data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
					...
					<div class="product product-style-2 equal-elem ">
						...
						<div class="product-info">
							<a href="{{route('product.details',['slug'=>$sproduct->slug])}}" class="product-name"><span>{{$sproduct->name}}
							</span></a>
							<div class="wrap-price"><ins><p class="product-price">රු.{{$sproduct->sale_price}}</p></ins> <del><p class="product-price">LKR.{{$sproduct->regular_price}}</p></del></div>
						</div>
					</div>
					@endforeach
		...
		<div class="row equal-container">
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="aboutus-box-score equal-elem ">
					...
					<p class="desc">Aswenna.lk Sri Lanka is delighted to provide its dedicated consumers a quick, simple, and dependable buying experience. We provide a distinctive online marketplace where customers from all around Sri Lanka may interact with merchants from various areas offering a variety of products.. </p>
				</div>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="aboutus-box-score equal-elem ">
					...
					<p class="desc">Aswenna.lk got the 90% of positive customer feedback rate. The information provided by customers about their experience with our products can be see under each products..</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="aboutus-box-score equal-elem ">
					<b class="box-score-title">over 1000</b>
					<span class="sub-title">Users of the site</span>
					<p class="desc">Awenna.lk is the most popular online market in South Asia, which enables tens of thousands of buyers to interact with millions of products..</p>
				</div>
			</div>
		</div>
	...
	<div class="banner-item">
		<a href="#" class="link-banner banner-effect-1">
			...
			<div class="wrap-show-advance-info-box style-1">
				<h3 class="title-box">LATEST PRODUCT</h3>
